...
return [
    ...
    [ // $dynamicRoutes
        ...
        200 => [[['_route' => 'delete-event', '_controller' => 'App\\Controller\\EventController::DeleteEvent'], ['id'], null, null, false, true, null]],
        228 => [[['_route' => 'update', '_controller' => 'App\\Controller\\EventController::update'], ['id'], null, null, false, true, null]],
        260 => [
            [['_route' => 'participate', '_controller' => 'App\\Controller\\EventController::ParticipateToEvent'], ['id'], null, null, false, true, null],
