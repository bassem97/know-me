 ...
 */
final class Version20210304193542 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE Discussions (user_id INT NOT NULL, Discussion_user_id INT NOT NULL, INDEX IDX_DEDE4B4A76ED395 (user_id), INDEX IDX_DEDE4B472764D18 (Discussion_user_id), PRIMARY KEY(user_id, Discussion_user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE Discussions ADD CONSTRAINT FK_DEDE4B4A76ED395 FOREIGN KEY (user_id) REFERENCES `user` (id)');
        $this->addSql('ALTER TABLE Discussions ADD CONSTRAINT FK_DEDE4B472764D18 FOREIGN KEY (Discussion_user_id) REFERENCES `user` (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE room DROP FOREIGN KEY FK_729F519BEEE8BD30');
        ...
        $this->addSql('ALTER TABLE Discussions DROP FOREIGN KEY FK_DEDE4B4A76ED395');
        $this->addSql('ALTER TABLE Discussions DROP FOREIGN KEY FK_DEDE4B472764D18');
